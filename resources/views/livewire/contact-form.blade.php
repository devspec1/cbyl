<form wire:submit.prevent='sendMessage' class="pb-16 mt-5 md:mt-0 md:py-16">
    <div class="relative z-0 mb-4 md:mb-6 w-full md:w-1/3 group">
        <label for="small-input"
            class="block mb-2 text-[18px] font-heading text-gray-900 {{ $errors->has('email') ? 'text-red-700' : '' }}">Email
            Address</label>
    ...
    <div class="relative z-0 mb-6 w-full group">
        <label for="small-input"
            class="block mb-2 text-[18px] font-heading text-gray-900 {{ $errors->has('message') ? 'text-red-700' : '' }}">Message</label>
    ...
    <div class="flex w-full md:mt-10">
        <button wire:loading.attr="disabled" type="submit"
            class="flex text-white bg-primary hover:bg-opacity-90 focus:ring-4 focus:outline-none focus:ring-purple-300 rounded-md text-sm sm:w-auto px-4 py-2 text-center md:mr-4 md:mx-0 justify-center items-center disabled:opacity-60">
